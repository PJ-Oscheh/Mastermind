...
This project is a simple version of Mastermind. It's similar to wordle,
but uses numbers rather than a word. I wasn't sure who the "mastermind" was
supposed to be (the player? the computer?) but I liked the idea of the
computer being an evil mastermind and the player needing to conquer its game.

That's as deep as the story writing goes. Here's the rules:
